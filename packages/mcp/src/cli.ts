...
Options:
  ...
  --max-plan-bytes <n>       Maximum metadata bytes per plan (65536..67108864; default 4194304)
  --max-total-plan-bytes <n> Maximum total plan metadata bytes (65536..536870912; default 33554432)
