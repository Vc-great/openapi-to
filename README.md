...
export function zodValidate(target: object, propertyKey: string, descriptor) {
    ...
    descriptor.value = async (...args) => {
        ...
        //response 校验
        const responseZodSchema = _.get(target, `_zodSchema.${propertyKey}.responseZodSchema`)
...
export const responseZodSchema = zodSchema => (target: object, propertyKey: string, descriptor) => {
    _.set(target, `_zodSchema.${propertyKey}.responseZodSchema`, zodSchema)
}

export const paramsZodSchema = zodSchema => (target: object, propertyKey: string, index) => {
