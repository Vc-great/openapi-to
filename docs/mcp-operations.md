...
The versioned baseline corpus has 1-operation small dialect fixtures, a 150-operation/81-schema medium document, a 700-operation/301-schema multi-file large document, a bounded 600-operation pathological document, and a 250-artifact generation fixture. The benchmark creates an isolated temporary 250-file Workspace for repeated full Prepare/Apply timing. Stress also seeds 100 operations from the 700/301 fixture, adds one operation through 100 repeated Selective Prepare calls, and requires a stable 101-operation projection, bounded output/RSS, and zero filesystem writes. Thresholds intentionally allow broad platform variance and never write benchmark output into the repository.
